...
# https://docs.microsoft.com/en-us/rest/api/synapse/sqlpools/resume
# POST https://management.azure.com/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Synapse/workspaces/{workspaceName}/sqlPools/{sqlPoolName}/resume?api-version=2019-06-01-preview

$uri = "https://management.azure.com/subscriptions/$SubscriptionID/"
$uri += "resourceGroups/$ResourceGroup/providers/Microsoft.Synapse/"
$uri += "workspaces/$workspaceName/sqlPools/$sqlPoolName/resume?api-version=2019-06-01-preview"
