...
GO
----------------------------------------------------------------------------------------------------------------------------------------------------------
--Cria função e schema da partição
----------------------------------------------------------------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------------------------------------------------------------
--Cria tabela que será usada pelo SSIS - TESTE1
----------------------------------------------------------------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------------------------------------------------------------
--Pega registros da tabela [TABELA_INCLUSAO] e joga na partição - TESTE1
--REALIZANDO UM SPLIT NA FUNÇÃO
----------------------------------------------------------------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------------------------------------------------------------
--Cria tabela que será usada pelo SSIS - TESTE 2
----------------------------------------------------------------------------------------------------------------------------------------------------------
PRINT CHAR(10)+CHAR(10)+CHAR(10)
PRINT '*********************************************'
PRINT 'DADOS TESTE 2'
...
----------------------------------------------------------------------------------------------------------------------------------------------------------
--Pega registros da tabela [TABELA_INCLUSAO] e joga na partição - TESTE 2
--REALIZANDO UM SPLIT NA FUNÇÃO
----------------------------------------------------------------------------------------------------------------------------------------------------------
ALTER PARTITION SCHEME [TesteScheme]
NEXT USED [PRIMARY]
...
PRINT CHAR(10)+CHAR(10)+CHAR(10)
PRINT '*********************************************'
PRINT 'DADOS TESTE 3 - REMOVENDO PARTIÇÃO'
PRINT '*********************************************'
----------------------------------------------------------------------------------------------------------------------------------------------------------
