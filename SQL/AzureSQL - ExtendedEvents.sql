...
(
	...
	WHERE name = 'https://fonsecanetstorage.blob.core.windows.net/extendedevents'
)
BEGIN
	--DROP DATABASE SCOPED CREDENTIAL [https://fonsecanetstorage.blob.core.windows.net/extendedevents]
	ALTER DATABASE SCOPED CREDENTIAL [https://fonsecanetstorage.blob.core.windows.net/extendedevents]
...
ELSE
BEGIN
	CREATE DATABASE SCOPED CREDENTIAL [https://fonsecanetstorage.blob.core.windows.net/extendedevents]
	WITH IDENTITY='SHARED ACCESS SIGNATURE',
	SECRET = 'sp=rwl&st=2018-03-09T16%3A45%3A00Z&se=2024-03-10T1xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx=xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxWM0%3D&sr=c'
END
---------------------------------------------------------------------------------------------------------
...
ADD TARGET package0.event_file(SET filename=N'https://fonsecanetstorage.blob.core.windows.net/extendedevents/XETrace.xel')
